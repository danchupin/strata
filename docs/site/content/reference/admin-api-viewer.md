...
build time by `make docs-openapi-copy` (a prerequisite of `make docs-build`
/ `make docs-serve`), so the viewer always reflects the contract at the same
SHA as the rest of the docs site.
